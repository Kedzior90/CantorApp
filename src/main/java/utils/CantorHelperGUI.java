...
//        super("JPanel Demo Program");
        mainGUI = new JPanel();
//        mainGUI = new JFrame("Cantor");
        mainGUI.setSize(400,400);
        mainGUI.setLayout(new GridLayout(3, 1));
        ...
        mainGUI.add(buttonCheckRates);
        mainGUI.add(buttonTransaction);
        mainGUI.add(buttonExit);
